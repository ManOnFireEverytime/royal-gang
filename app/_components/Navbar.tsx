        ...
        >
          ...
          <div className="w-full text-center lg:hidden">
            ...
            <div className="mt-8 space-y-4">
              <p className="text-xl font-semibold text-customGrey">
                Categories
              </p>
              {isLoading ? (
            ...
            {/* Mobile User Info */}
            {isAuthenticated && user && (
              <div className="mt-8 space-y-4 border-t-2 pt-8">
                <p className="text-xl text-customGrey">
                  Hi, {user.first_name}
                </p>
                <button
                  onClick={() => {
                  ...
                  className="text-lg text-customGrey transition-colors duration-500 hover:text-red-600"
                >
                  Logout
                </button>
              </div>
